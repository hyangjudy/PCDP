...
public final class ReciprocalArraySum {
    ...
    private static class ReciprocalArraySumTask extends RecursiveAction {
        ...
        private int SEQUENTIAL_THRESHOLD = 100000;
        ...
        ReciprocalArraySumTask(final int setStartIndexInclusive,
            ...
            this.input = setInput;
            SEQUENTIAL_THRESHOLD = (chunkSize + setInput.length - 1) / chunkSize;
        }
        ...
        protected void compute() {
            ...
            if (endIndexExclusive - startIndexInclusive < SEQUENTIAL_THRESHOLD) {
                ...
                int midIndex = (endIndexExclusive - startIndexInclusive) / 2 + startIndexInclusive;
    ...
    protected static double parManyTaskArraySum(final double[] input,
        ...
        tasks.stream().map(ReciprocalArraySumTask::join);
        return tasks.stream().map(ReciprocalArraySumTask::getValue).reduce(Double::sum).orElse(0.0);
    }
}
